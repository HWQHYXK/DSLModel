...
public class OrderDao
{
    ...
    private void init()
    {
        sqls.add("CREATE TABLE IF NOT EXISTS GspOrder(ID VARCHAR(36) NOT NULL , Code VARCHAR(50) NOT NULL , Name VARCHAR(50) NOT NULL , Price DOUBLE(8, 2), OrderCount INT, OrderAmount DOUBLE(8, 2), Status INT, IsVip BOOL, Date DATETIME)ENGINE=InnoDB DEFAULT CHARSET=utf8;");
    }
